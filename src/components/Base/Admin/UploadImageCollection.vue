...
<template>
    <div class="edit-image">
        ...
        <div v-if="imageId" class="text link">
            delete {{ imageId }}
        </div>
    </div>
</template>
...
<script>
    ...
    import { useCollectionUploadImage} from '@/use/useApi'
    ...
    export default {
        ...
        setup(props, {emit}) {
            ...
            const { data: stored, fetchData: uploadImage,  isLoading} = useCollectionUploadImage()
