export default {
    ...
    page: {
        ...
        checkout: {
            title: 'Оформление заказа в интернет-магазине vostok-europe.shop',
            description: 'Оформление онлайн-заказов часов на сайте 24 часа в сутки 7 дней в неделю. '
        },
        login: {
            title: 'Вход или регистрация нового пользователя',
            description: 'Вход в существующий аккуант или регистрация нового пользователя в часовом интернет-магазине vostok-europe.shop'
        },
        contact: {
        ...
        cart: {
            title: 'Корзина с товарами. Покупка часво марки Восток-Европа (Vostok Europe)',
            description: 'Закажите онлайн понравившиеся вам часы марки Vostok Europe, которые вы добавили в корзину.'
        },
        thanks: {
            title: 'Спасибо за заказ',
            description: 'Рассмотрим заявку и оперативно свяжемся с вами для подтверждения вашего заказа'
        }
    },
    thanks: {
